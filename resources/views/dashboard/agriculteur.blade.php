...
@section('title', 'Tableau de bord - Agriculteur')
    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <div class="mt-3">
                    <a href="{{ route('complaints.create') }}" class="btn btn-info text-white">
                        <i class="fas fa-plus"></i> Nouvelle réclamation
                    </a>
                    <a href="{{ route('complaints.index') }}" class="btn btn-outline-info">
                        Voir toutes
                    </a>
                </div>
            </div>
